...
?>
	<h1 class="jema_cv_title">Projets</h2><br/>

	<h2 class="jema_cv_subtitle"><a href="https://github.com/jean-massat/Jean-Massat" target="about:blank">Jean Massat (2013)</a></h3>
	<p class="jema_cv_p">
		Jean-Massat est le site sur lequel vous vous trouvez actuellement. Il m'a fallu un mois entier environ avant de le mettre au point avec la quasi totalité
		des composants et fonctionnalités prévues initialements.<br/>

		Pour la structure PHP de base, le projet est sous la forme d'un composant MVC Joomla. Donc un framework PHP avec une API associée (Joomla 3.1).<br/>
