...
<div class="jema_content">
	...
	<?php
		...
		if(isset($user->groups[8]) || isset($user->groups[7])){
			...
			echo "<div class=\"jema_hidden jema_form_article\"><form enctype=\"multipart/form-data\" action=\"#\" method=\"post\">";
			echo "<label>Nom de l'article:</label><input type=\"text\" name=\"titre_article\"/>";
			echo "<label>Rédaction de l'article en lui même:</label><textarea rows=\"10\" style=\"width:600px; height:300px;\" name=\"content_article\"></textarea>"; 
