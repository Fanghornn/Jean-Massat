...
?>
	...
	<div class="jema_home">
		...
		<p class="jema_paragraph_welcome">
			...
			Si vous souhaitez en savoir plus sur moi, c'est dans la section "A propos" qu'il faudra vous rendre.

			Je vous souhaite une bonne navigation sur Fanghornn.com !
		</p>
	</div>
</div>