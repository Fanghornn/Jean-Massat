...
?>
	...
	<p class="jema_about_p">
		...
		C'est ainsi que je me suis rendu compte de l'efficacité d'internet quant à l'autoapprentissage , et des nombreuses possibilités qu'offrait cet outil.<br/><br/>
		C'est à partir de mes 12 ans que je me suis épris de l'informatique et de tout l'univers annexe. J'ai donc passé la plus grande partie des années qui ont suivi à réparer des machines, à examiner leur contenu ainsi que leur fonctionnement.
		...
		notamment en y contribuant. Ces quelques mois de stage m'ont d'autant plus confirmé l'attrait que je porte quant au développement web tout en solidifiant mes compétences.<br/><br/>
		...
		À ce même titre, j'espère vous avoir montré mon désir d'optimiser mes compétences ainsi que l'entrain que j'exerce au quotidien pour l'informatique, le développement web et tous les éléments gravitants autour de ces deux concepts capitaux.
	</p>
